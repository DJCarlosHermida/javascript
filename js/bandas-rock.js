...
const banda01 = new BandasRock(1, '1949', 'Bill Haley & His Comets', 'https://arc-anglerfish-arc2-prod-infobae.s3.amazonaws.com/public/HGSYSSXY2JFUVCU36IBC674ZLY.jpg')
const banda02 = new BandasRock(2, '1950', 'Los TNT', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRgvf_rH2TF8K5-T3xObFuc2HLApZp6goNEOIi2rRsO6w&s')
const banda03 = new BandasRock(3, '1951', 'Jackie Brenston', 'https://cdns-images.dzcdn.net/images/artist/e7294a79c068b8faac2b7543bb7d9464/500x500.jpg')
const banda04 = new BandasRock(4, '1952', 'Alan Freed', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRSEpzk5IPoB8wfrCs1Lv1JyYxX1k0lkPZyOrzA7-9HpO5RXC7xTEI_Ee13ZneNZpeIfDc&usqp=CAU')
const banda05 = new BandasRock(5, '1953', 'Elvis Presley', 'https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/elvis-presley-1534412061.jpg?crop=0.974xw:1.00xh;0.0144xw,0&resize=640:*')
const banda06 = new BandasRock(6, '1954', 'The Spinners', 'https://thespinners.com/wp-content/uploads/2021/07/TheSpinners_LayeredCover.jpg')
const banda07 = new BandasRock(7, '1955', 'The Tokens', 'https://i.discogs.com/VZlKKpjaQorVGqCl4qisxu_FStt6JbtYnnaEY0_H8W8/rs:fit/g:sm/q:40/h:300/w:300/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9BLTI2OTA5/Mi0xNjYyMTMxNzAz/LTE2MjAuanBlZw.jpeg')
const banda08 = new BandasRock(8, '1956', 'Chuck Berry', 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c4/Chuck_Berry_Midnight_Special_1973.JPG/220px-Chuck_Berry_Midnight_Special_1973.JPG')
const banda09 = new BandasRock(9, '1957', 'The Crickets', 'https://e.snmc.io/i/1200/s/53804cc399a20a531522f964f5df97b8/1518039')
...
const banda11 = new BandasRock(11, '1959', 'The Kingsmen', 'https://www.rollingstone.com/wp-content/uploads/2021/04/GettyImages-74280080.jpg')
...
const banda19 = new BandasRock(19, '1967', 'Creedence Clearwater Revival', 'https://elcomercio.pe/resizer/QXko2mdg0d9s4GarjrwGC7WYIM0=/580x330/smart/filters:format(jpeg):quality(75)/cloudfront-us-east-1.images.arcpublishing.com/elcomercio/FJJVEAOQPRAOPHP564VMWD5IVY.jpg')
...
const banda25 = new BandasRock(25, '1973', 'AC/DC', 'https://www.guioteca.com/rock/files/2014/04/acdc-highway-two-hell-445_opt.jpg')
...
const banda34 = new BandasRock(34, '1982', 'Soda Stereo', 'https://www.cmtv.com.ar/imagenes_artistas/276.jpg?Soda%20Stereo')
...
const banda52 = new BandasRock(52, '2000', 'Linkin Park', 'https://static.eldiario.es/clip/1df45631-4f7d-44c7-a149-9b85b3eceb4f_16-9-aspect-ratio_default_0.jpg')
...
const banda55 = new BandasRock(55, '2003', 'Red Hot Chili Peppers', 'https://img.youtube.com/vi/YlUKcNNmywk/maxresdefault.jpg?auto=webp&width=494')
